...
create table nhan_vien (
    ...
    email varchar(45),
    dia_chi varchar(45),
    constraint fk_id_vi_tri foreign key (id_vi_tri)
		references vi_tri(id_vi_tri),
    constraint fk_id_trinh_do foreign key (id_trinh_do)
		references trinh_do(id_trinh_do),
	constraint fk_id_bo_phan foreign key (id_bo_phan)
		references bo_phan(id_bo_phan)
);

-- data for table nhan_vien
insert into nhan_vien ( ho_ten , ngay_sinh , so_cmnd , luong , sdt , email , dia_chi , id_vi_tri, id_trinh_do ,
	id_bo_phan) value
	('Dang Thi Kim Anh', '1983-02-26', '206339509', '80.000.000', '0335194534', 'dangthikimanh47@gmail.com',
		'Quang Nam',1,1,1),
    ('Hoang Xuan Anh', '1990-02-22', '194471442', '50.000.000', '0394520208', 'hoangxuananh222@gmail.com', 
		'Quang Binh',2,1,1),
    ('Nguyen Nho Minh Anh', '1993-09-02', '205948405', '30.000.000', '0764065918', 'salaka.awt@gmail.com',
		'Quang Nam',3,2,2),
    ('Vuong Thi Kim Cuc', '1997-03-09', '197430412', '15.000.000', '0396627644', 'kimcuc10b1@gmail.com', 
		'Quang Tri',4,2,2),
    ('Bui Van Thanh Diem', '1996-04-19', '212481532', '8.000.000', '0969141927', 'thanhdiem1904@gmail.com', 
		'Quang Ngai',5,3,2),
    ('Le Ho Ngoc Dieu', '1996-01-12', '191993993', '8.000.000' , '0969603450', 'lehongocdieu1996@gmail.com',
		'Da Nang',6,3,2),
    ('Le Duc Anh Dung', '1997-06-22', '194578629', '15.000.000', '0965719027', 'ledung@gmail.com',
		'Quang Binh',7,2,3),
    ('Nguyen Thi Thu Ha', '1997-10-12', '194621635', '8.000.000', '0981282897', 'nguyenthuha@gmail.com',
		'Quang Binh',8,4,3),
    ('Phan Thi Le Hang', '1996-08-27', '212827397', '10.000.000', '0967021634', 'phanthilehang1996@gmail.com',
		'Da Nang',9,3,3),
    ('Nguyen Thi An Hoa', '1997-06-18', '206117711', '15.000.000', '0356749171', 'anhoa15697@gmail.com',
		'Binh Phuoc',10,2,4),
    ('Le Thi Dieu Huyen', '1996-09-07', '233231932', '8.000.000', '0375753631', 'lehuyenx2@gmail.com',
		'Da Nang',11,4,4),
    ('Ha Le Thanh Huyen', '1993-05-02', '241797370', '8.000.000', '0388306302', 'huyenmup93@gmail.com',
		'Dak Lak',12,4,4),
    ('Ha Manh Hung', '1995-08-20', '241496341', '20.000.000', '0974508315', 'manhhung10ct@gmail.com',
		'Dak Lak',13,2,4),
    ('Vo Van Hung', '1997-07-27','191897403','12.000.000','0793658056','vovanhung35@gmail.com',
		'Hue',14,4,4),
    ('Nguyen Van Khuong', '1997-03-01','205959015','8.000.000','0772480787','khuong97dx2@gmail.com',
		'Quang Nam',15,4,4),
    ('Huynh Phi Long', '1993-02-13','206007258','15.000.000','0962853800','huynhphilong13021997@gmail.com',
		'Quang Nam',16,2,5),
    ('Truong Vu Thanh Lam', '1989-04-12','212671089','10.000.000','0967 521 607','truongvuthanhlam0204@gmail.com',
		'Quang Ngai',17,2,5),
    ('Ho Thi Nhuoc Nam','1990-03-22','191895504','10.000.000','0395292964','nhuocnam223@gmail.com',
		'Hue',18,2,5),
    ('Ta Thi Huyen Nga','1995-11-03','233231669','10.000.000','0966272397','huyennga03111997@gmail.com',
		'Kom Tum',19,2,5),
    ('Cao Tuan Ngoc', '1990-06-17','191898082','15.000.000','0386537063','caotuanngoc123456789@gmail.com',
		'Hue',20,2,6),
    ('Nguyen Thi Lam Nguyen', '1996-01-05','285661059','10.000.000',' 0345300960','nguyenthilamnguyen0501@gmail.com',
		'Binh Phuoc',21,2,6),
    ('Hoang Thi Thu Nhan', '1993-04-18','233234792','10.000.000','0966269474','thunhan18497@gmail.com',
		'Dak Lak',22,2,6),
    ('Truong Viet Nhan', '1996-04-26','197275982','8.000.000','0962853900','voirung2409@gmail.com',
		'Quang Tri',23,3,6),
    ('Pham Huynh Quang Nhat','1992-01-27','205943256','15.000.000','0977754791','phamhuynhquangnhat@gmail.com',
		'Quang Nam',24,2,7),
    ('Che Ngoc Van Nhi','1993-09-22','191896201','10.000.000','0767142295','vannhiche@gmail.com',
		'Hue',25,2,7),
    ('Phan Thi Thanh Nhung','1997-07-31','206117116','8.000.000','0389582160','phannhung3107@gmail.com',
		'Quang Nam',26,3,7);
...
create table khach_hang(
	...
	email varchar(45),
	dia_chi varchar(45),
	constraint fk_id_loai_khach foreign key (id_loai_khach)
...
create table dich_vu (
    ...
    constraint fk_id_kieu_thue foreign key (id_kieu_thue)
		references kieu_thue(id_kieu_thue),
	constraint fk_id_loai_dich_vu foreign key (id_loai_dich_vu)
		references loai_dich_vu(id_loai_dich_vu)
);

-- data for table dich_vu
insert into dich_vu (id_kieu_thue, id_loai_dich_vu, ten_dich_vu, dien_tich, so_tang, so_nguoi_toi_da, 
	chi_phi_thue, trang_thai) value
...
create table hop_dong (
    ...
    tien_dat_coc int,
    tong_tien int,
    constraint fk_id_nhan_vien foreign key (id_nhan_vien)
	...
	constraint fk_id_dich_vu foreign key (id_dich_vu)
...
create table hop_dong_chi_tiet (
    ...
    constraint fk_id_hop_dong foreign key (id_hop_dong)
		references hop_dong(id_hop_dong),
	constraint fk_id_dich_vu_di_kem foreign key (id_dich_vu_di_kem)
...
insert into hop_dong_chi_tiet(id_hop_dong, id_dich_vu_di_kem, so_luong) value
    (2, 2, 1), (3, 2, 2), (3, 2, 1), (5, 3, 1), 
    (3, 2, 1), (4, 4, 1), (1, 6, 1), (2, 1, 1),
	(6, 3, 2), (7, 5, 2), (8, 2, 1), (9, 3, 1), 
    (10, 4, 1),(11, 3, 1), (12, 4, 3),(13, 4, 2),
	(14, 4, 3),(15, 4, 3), (16, 5, 2);
update hop_dong_chi_tiet set id_dich_vu_di_kem = 4 where ( id_hop_dong_chi_tiet = 4 or 
id_hop_dong_chi_tiet= 9 or id_hop_dong_chi_tiet= 12 or id_hop_dong_chi_tiet=14);

/* task 2: Hien thi tat ca cac nhan vien co trong he thong co ten bat dau la 1 trong cac ki tu "H", "K",
	hoac "T" va toi da 15 ki tu */
select * from nhan_vien 
where ((ho_ten like 'H%') or (ho_ten like 'K%') or (ho_ten like 'T%')) and length(ho_ten) <= 15;

/* task 3: Hien thi tat ca thong tin cua khach hang co do tuoi tu 18-50 va dia chi "Da Nang" hoac "Quang Tri" */
select * from khach_hang
	where (year(curdate()) - year(ngay_sinh) between 18 and 50) and dia_chi in ('Da Nang', 'Quang Tri');
    
/* task 4: Dem xem tuong ung moi khach hang da tung dat phong bao nhieu lan. Ket qua hien thi sap xep tang dan 
	theo so lan dat phong cua khach hang. Chi dem nhung khach hang co ten loai khach hang la diamond */
select hop_dong.id_khach_hang, khach_hang.ho_ten, khach_hang.id_loai_khach, count(hop_dong.id_khach_hang)
	as so_lan
from hop_dong
...
/* task 5: hien thi id_khach_hang, ho_ten, ten_loai_khach, id_hop_dong, ten_dich_vu, ngay_lam_hop_dong, 
	ngay_ket_thuc, tong_tien = chi_phi_thue + so_luong*gia cho tat ca khach hang tung dat phong. 
...
right join loai_khach on khach_hang.id_loai_khach = loai_khach.id_loai_khach
left join dich_vu on hop_dong.id_dich_vu = dich_vu.id_dich_vu;

/* task 6: Hien thi id_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, ten_loai_dich_vu cua tat ca cac dich vu 
	chua tung duoc khach hang dat tu quy 1 nam 2019 */
...
/* task 8: hien thi thong tin khach hang ho_ten voi yeu cau ho ten khong trung nhau theo 3 cach khac nhau */
-- cach 1:
...
/* task 9: thuc hien thong ke doanh thu theo thang, nghia la tuong ung voi moi thang trong nam 2019 
	se co tuong ung bao nhieu khach hang dat phong */
...
/* task 10: Hien thi tuong ung voi tung hop dong thi da su dung bao nhieu dich vu di kem.
	Ket qua hien thi bao gom:id_hop_dong, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, so_luong_dich_vu_di_kem */
...
/* task 11: Hien thi thong tin cac dich vu di kem da duoc su dung boi nhung khach hang có ten 
	loai_khach_hang la diamond va dia_chi la 'Vinh' hoac 'Quang Ngai' */
...
inner join khach_hang on hop_dong.id_khach_hang = khach_hang.id_khach_hang
inner join loai_khach on khach_hang.id_loai_khach = loai_khach.id_loai_khach
where loai_khach.id_loai_khach = 1 and khach_hang.dia_chi in ('Vinh', 'Quang Ngai'); 

/* task 12: hien thi thong tin id_hop_dong, ten_nhan_vien, ten_khach_hang, sdt_khach_hang, ten_dich_vu, 
	so_luong_dich_vu_di_kem, tien_dat_coc cua tat ca cac dich vu da duoc khach hang dat 3 thang cuoi nam 2019 
    ma chua tung dat o 6 thang dau 2019 */
select hop_dong.id_hop_dong, nhan_vien.ho_ten as ten_nhan_vien, khach_hang.ho_ten as ten_khach_hang,
	khach_hang.sdt as sdt_khach_hang, dich_vu.ten_dich_vu, hop_dong.tien_dat_coc,
...
where (hop_dong.ngay_lam_hop_dong between '2019-10-01' and '2019-12-31')
	and hop_dong.id_hop_dong not in
(
...
/*select hop_dong.id_hop_dong, loai_dich_vu.ten_loai_dich_vu, dich_vu_di_kem.ten_dich_vu_di_kem,
	count(hop_dong.id_hop_dong) as so_lan
from dich_vu_di_kem
inner join hop_dong_chi_tiet on dich_vu_di_kem.id_dich_vu_di_kem = hop_dong_chi_tiet.id_dich_vu_di_kem
inner join hop_dong on hop_dong_chi_tiet.id_hop_dong = hop_dong.id_hop_dong
inner join dich_vu on hop_dong.id_dich_vu = dich_vu.id_dich_vu
inner join loai_dich_vu on dich_vu.id_loai_dich_vu = loai_dich_vu.id_loai_dich_vu
group by hop_dong.id_hop_dong, loai_dich_vu.ten_loai_dich_vu, dich_vu_di_kem.ten_dich_vu_di_kem
having so_lan = 1;*/
...
/* task 15: Hien thi thong tin cua tat ca nhan vien bao gom id_nhan_vien, ho_ten, trinh_do, ten_bo_phan, 
	so_dien_thoai, dia_chi moi chi lap duoc 3 hop dong tu nam 2018 den 2019 */
select nhan_vien.id_nhan_vien, ho_ten, trinh_do.trinh_do, bo_phan.ten_bo_phan, sdt, dia_chi, 
	count(nhan_vien.id_nhan_vien) as so_luong_hop_dong
from nhan_vien
...
/* task 17: cap nhat thong tin nhung khach hang co ten loai tu platinium len diamond chi cap nhat nhung khach hang 
	da tung dat phong voi tong tien trong nam 2019 lon hon 10.000.000 */
update khach_hang
inner join hop_dong on khach_hang.id_khach_hang = hop_dong.id_khach_hang
set id_loai_khach = 1
where id_loai_khach = 2 and (hop_dong.ngay_lam_hop_dong between '2019-01-01' and '2019-12-31') and
...
left join hop_dong_chi_tiet on hop_dong_chi_tiet.id_hop_dong = hop_dong.id_hop_dong
 where not exists (select hop_dong.id_hop_dong from hop_dong where hop_dong.ngay_lam_hop_dong > '2016-01-01' 
...
(
	select hop_dong_chi_tiet.id_dich_vu_di_kem, count(hop_dong_chi_tiet.id_dich_vu_di_kem) as so_lan
    from hop_dong_chi_tiet
    inner join hop_dong on hop_dong_chi_tiet.id_hop_dong = hop_dong.id_hop_dong
    where year(hop_dong.ngay_lam_hop_dong) = 2019
    group by dich_vu_di_kem.id_dich_vu_di_kem
...
/* task 20: hien thi tat ca cac nhan vien va khach hang co trong he thong noi dung hien thi id 
	(id_nhan_vien, id_khach_hang) ho_ten, email, so_dien_thoai, ngay_sinh, dia_chi */
